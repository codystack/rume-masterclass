                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card bg-opaque-white">
                                        ...
                                        <?php
                                            $id = $_GET['id'];
                                                $select_query = "SELECT * FROM exhibitors WHERE id ='$id'";
                                        ...
                                        <div class="card-body bg-white">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" required name="firstName" disabled value="<?php echo $contactperson; ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="lastName" class="form-label">Brand Name</label>
                                                    <input type="text" class="form-control" required name="lastName" disabled value="<?php echo $companyName; ?>">
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="company" class="form-label">Items to be Exhibited</label>
                                                    <textarea type="text" name="items" required class="form-control form-control-lg form-control-white" disabled rows="2" placeholder="Items to be exhibited *"><?php echo $items; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <?php 
